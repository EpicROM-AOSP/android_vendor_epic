...
ifeq ($(WITH_GAPPS),true)
    include vendor/epic/config/gms.mk
endif	

# epic-specific broadcast actions whitelist
PRODUCT_COPY_FILES += \
    vendor/epic/config/permissions/lineage-sysconfig.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/lineage-sysconfig.xml

# epic-specific init rc file
PRODUCT_COPY_FILES += \
    vendor/epic/prebuilt/common/etc/init/init.lineage-system_ext.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.lineage-system_ext.rc
...
$(call inherit-product, vendor/epic/bootanimation/bootanimation.mk)
...
PRODUCT_COPY_FILES += \
    vendor/epic/prebuilt/common/etc/init/init.lineage-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.lineage-updater.rc
...
PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/epic/build/target/product/security/lineage
...
-include vendor/epic/config/partner_gms.mk
